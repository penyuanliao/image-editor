...
watch(
  [textProps, shadow, stroke, gradient],
  () => {
...
const handleFontSelectVisibleChange = (visible: boolean) => {
  if (visible) {
    ...
    if (inputEl) {
      inputEl.focus();
      inputEl.$el.querySelector("input")?.addEventListener("keydown", handleFontSelectKeyDown);
    }
  } else {
    const inputEl = fontSelectRef.value;
    if (inputEl) {
      inputEl.$el.querySelector("input")?.removeEventListener("keydown", handleFontSelectKeyDown);
    }
    ...
    <div class="categories" v-if="props.controlEnabled">
      ...
      <div class="ctrl color-picker-rectangle">
        ...
        <ColorPicker
          use-type="pure"
          format="hex"
          v-model:pureColor="textProps.color"
          @pureColorChange="handleSaveHistory"
        />
      </div>
      <div class="ctrl">
        <el-select
        ...
        <div>
          <el-tooltip content="粗體" placement="top">
            <el-checkbox-button
              class="el-checkbox-btn"
              v-model="textProps.isBold"
              @change="handleSaveHistory"
            >
              <el-icon size="18">
                <svg
                ...
                >
                  <path
                    d="M5.114 3.471A1.319 1.319 0 0 0 4.2 1.2H1.92a.24.24 0 0 0-.24.24V6a.24.24 0 0 0 .24.24h2.64a1.44 1.44 0 0 0 .554-2.769M2.16 1.68H4.2a.84.84 0 0 1 0 1.68H2.16Zm2.4 4.08h-2.4V3.84h2.4a.96.96 0 0 1 0 1.92"
                  />
                </svg>
              </el-icon>
            </el-checkbox-button>
          </el-tooltip>
          <el-tooltip content="斜體" placement="top">
            <el-checkbox-button
              class="el-checkbox-btn"
            ...
            >
              <el-icon size="18">
                ...
                >
                  <path
                    d="M6 1.68a.24.24 0 0 1-.24.24H4.733l-1.28 3.84h.867a.24.24 0 0 1 0 .48h-2.4a.24.24 0 0 1 0-.48h1.027l1.28-3.84H3.36a.24.24 0 0 1 0-.48h2.4a.24.24 0 0 1 .24.24"
                  />
                </svg>
              </el-icon>
            </el-checkbox-button>
        ...
        <el-radio-group
          ...
          v-model="textProps.textAlign"
          fill="#F15624"
          @change="handleSaveHistory"
        >
          <el-tooltip content="靠左對齊" placement="top">
            <el-radio-button value="left">
              <el-icon size="24">
                ...
                >
                  <path
                    d="M1.08 2.04a.12.12 0 0 1 .12-.12h5.28a.12.12 0 0 1 0 .24H1.2a.12.12 0 0 1-.12-.12m.12 1.32h3.84a.12.12 0 0 0 0-.24H1.2a.12.12 0 0 0 0 .24m5.28.96H1.2a.12.12 0 1 0 0 .24h5.28a.12.12 0 0 0 0-.24m-1.44 1.2H1.2a.12.12 0 1 0 0 .24h3.84a.12.12 0 0 0 0-.24"
                  />
                </svg>
              </el-icon>
            </el-radio-button>
          </el-tooltip>
          <el-tooltip content="置中對齊" placement="top">
            <el-radio-button value="center">
              <el-icon size="24">
                ...
                >
                  <path
                    d="M1.08 2.04a.12.12 0 0 1 .12-.12h5.28a.12.12 0 0 1 0 .24H1.2a.12.12 0 0 1-.12-.12m.84 1.08a.12.12 0 0 0 0 .24h3.84a.12.12 0 0 0 0-.24Zm4.56 1.2H1.2a.12.12 0 1 0 0 .24h5.28a.12.12 0 0 0 0-.24m-.72 1.2H1.92a.12.12 0 0 0 0 .24h3.84a.12.12 0 0 0 0-.24"
                  />
                </svg>
              </el-icon>
            </el-radio-button>
          </el-tooltip>
          <el-tooltip content="靠右對齊" placement="top">
            <el-radio-button value="right">
              <el-icon size="24">
                ...
                >
                  <path
                    d="M1.08 2.04a.12.12 0 0 1 .12-.12h5.28a.12.12 0 0 1 0 .24H1.2a.12.12 0 0 1-.12-.12m5.4 1.08H2.64a.12.12 0 0 0 0 .24h3.84a.12.12 0 0 0 0-.24m0 1.2H1.2a.12.12 0 1 0 0 .24h5.28a.12.12 0 0 0 0-.24m0 1.2H2.64a.12.12 0 1 0 0 .24h3.84a.12.12 0 0 0 0-.24"
                  />
                </svg>
              </el-icon>
            </el-radio-button>
      ...
      <div v-if="shadow.enabled" class="sub-controls">
        <div class="color-picker-square">
          ...
          <ColorPicker
            use-type="pure"
            format="hex"
            v-model:pureColor="shadow.color"
            @pureColorChange="handleSaveHistory"
          />
        </div>
        <div>
      ...
      <div v-if="stroke.enabled" class="sub-controls">
        <div class="color-picker-square">
          ...
          <ColorPicker
            use-type="pure"
            format="hex"
            v-model:pureColor="stroke.color"
            @pureColorChange="handleSaveHistory"
          />
        </div>
        <div>
